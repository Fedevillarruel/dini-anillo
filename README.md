...
La misma actualización consulta el servicio BLE estándar de batería (`180F` / `2A19`) y muestra el porcentaje cuando el firmware lo expone. Algunos Lefun usan un UUID propietario para batería; en ese caso el diagnóstico de hardware permite identificarlo sin mostrar un valor inventado.
